        ...
        try:
            ...
            for r in data.get("results", []):
                flight = FlightResult(
                    ...
                    return_departure_airport=r.get("return_departure_airport", ""),
                    return_arrival_airport=r.get("return_arrival_airport", ""),
                    baggage=r.get("baggage", ""),
                    return_baggage=r.get("return_baggage", ""),
                    seat_availability=int(r.get("seat_availability", 0) or 0),
                    arrival_day_offset=int(r.get("arrival_day_offset", 0) or 0),
                    return_arrival_day_offset=int(r.get("return_arrival_day_offset", 0) or 0),
                    recommendation_tag=r.get("recommendation_tag", ""),
