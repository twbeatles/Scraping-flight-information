    ...
    def search_multiple_destinations(self, origin: str, destinations: List[str],
        ...
        def search_single(dest: str) -> tuple:
            ...
            try:
                ...
                scraper = getattr(searcher, "scraper", None)
                ...
                if hasattr(searcher, "search"):
                ...
                elif scraper is not None and hasattr(scraper, "search"):
                    ...
                    raise AttributeError("FlightSearcher does not provide a searchable interface")
                return dest, results
